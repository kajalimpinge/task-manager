...
export default class CardsContainer extends Component {
  ...
  render() {
    const { connectDropTarget, connectDragSource, item, x, onAddNewCard, moveCard, isDragging } = this.props;
    const opacity = isDragging ? 0.5 : 1;

    return connectDragSource(connectDropTarget(
      <div className="desk" style={{ opacity }} onDoubleClick={this.handleAddNewList}>
